...
TPR13Dialog::TPR13Dialog(QWidget *parent)
    : QDialog(parent), ui(new Ui::TPR13Dialog) {
  ui->setupUi(this);
}

TPR13Dialog::~TPR13Dialog() { delete ui; }
...
void TPR13Dialog::on_buttonBox_accepted() { emit GetTPR13Data(TPRConfigValue); }
